/*
    CapiMovil - Script consolidado de registros (24/04)
    Entidades:
    - PadreFamilia
    - Conductor
    - Estudiante
    ...
    Nota:
    - Requiere que existan dbo.fn_Codigo_Fragmento y dbo.CorrelativoDocumento.
    - Retorno unificado: SELECT FilasAfectadas, CodigoGenerado [, Mensaje].
*/
